...
---
**Clarification on Sept 9th, 2026: This document is only for sharing what, our experience, we think works best in Philadelphia, PA. We aren't suggesting that everyone else nationwide (especially in areas where interference with 33cm is a bigger issue) take up our custom MeshCore 500 settings. This document is to tell you what we did, what we found out, and what we're looking at now. We'd love to see one main recommended legal USA default, but right now it doesn't seem like anyone has found it yet.**
