...
---
Philly Mesh has a an optional 4096-bit GPG key that you can use for email correspondence.

  * [See it on MIT's Public Key Server][1]
...
```
 ...
 [1]: https://pgp.mit.edu/pks/lookup?search=0x8F5B291D3A3CA65A&op=vindex&fingerprint=on
 [2]: ttps://keybase.io/phillymesh